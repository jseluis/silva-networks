...
PACKAGE_CITATIONS = {
    ...
    "19_silva_homotopy_equilibrium_lab.ipynb": (1, 7, 46, 58),
    ...
    "27_reproducing_silva_and_source_methods.ipynb": (
        1,
        4,
        5,
        7,
    ...
    "28_silva_consistency_deq.ipynb": (1, 4, 59, 65, 66, 67),
    "29_silva_psi_gnn.ipynb": (1, 4, 60, 72),
    "30_silva_ifno_materials.ipynb": (1, 31, 32, 61),
    "31_silva_snarf_forward_skinning.ipynb": (1, 4, 62, 68, 69, 70, 71),
    "32_silva_mesh_inference.ipynb": (1, 4, 63),
    "33_silva_physics_guided_diffusion_pde.ipynb": (1, 32, 64),
    "34_silva_therino_mechanics.ipynb": (1, 4, 31, 32, 73),
    "35_silva_fixed_point_diffusion.ipynb": (1, 4, 49, 74),
    "36_silva_monotone_operator_equilibrium.ipynb": (1, 4, 75, 81),
    "37_silva_positive_concave_equilibrium.ipynb": (1, 4, 76, 81),
    "38_silva_non_euclidean_equilibrium.ipynb": (1, 4, 77, 81),
    "39_silva_efficient_infinite_graph.ipynb": (1, 4, 78, 82),
    "40_silva_multiscale_graph_implicit.ipynb": (1, 4, 78, 79, 82),
    "41_silva_delta_equilibrium.ipynb": (1, 4, 22, 23, 37, 80, 83, 84, 85, 86),
    ...
    "43_cross_family_vector_benchmark.ipynb": (1, 4, 75, 76, 77, 80),
    "44_cross_family_graph_benchmark.ipynb": (1, 36, 47, 78, 79),
