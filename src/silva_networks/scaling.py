...
_FAMILY_GUIDES: dict[str, SILVAFamilyGuide] = {
    ...
    for guide in (
        ...
        _guide(
            ...
            "joint deterministic diffusion trajectory equilibrium",
            "noise plus declared schedule/denoiser -> terminal sample",
            (38,),
            (_SILVA_REPOSITORY,),
            ("CIFAR-10 or task-specific diffusion trajectories",),
            ("trajectory length", "denoiser memory", "phantom or implicit gradients"),
            ("replace the denoiser and schedule", "add trajectory supervision"),
        ),
        _guide(
            "scientific_operator",
