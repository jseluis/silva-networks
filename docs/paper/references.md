...
<ol class="silva-reference-list">
  ...
  <li id="ref-2">Silva, Jose Luis. <em>SILVA Networks</em>, version 1.2.1. Software archive, 2026. All-versions DOI: 10.5281/zenodo.21770098. <a href="https://doi.org/10.5281/zenodo.21770098" target="_blank" rel="noopener">Archive record</a>. BibTeX: <code>silva2026silvanetworkssoftware</code>.</li>
