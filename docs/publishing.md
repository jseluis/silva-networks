...
later releases use the same publisher identity:
...
4. Push the validated version tag, currently `v1.2.1`; the release workflow
...
Publishing the `v1.2.1` GitHub release creates a new version record under the
