# `silva_homotopy_equilibrium` Reproduction Dossier

**continuous path to a SILVA fixed point.** This dossier connects the source mechanism to its SILVA
...
| Task contract | condition B,D -> terminal equilibrium state/output |
| Source relation | `paper-adaptation` |
| References | [[7]](../paper/references.md#ref-7){ .silva-cite }, [[46]](../paper/references.md#ref-46){ .silva-cite }, [[58]](../paper/references.md#ref-58){ .silva-cite } |
| Repositories | <a href="https://github.com/wadx2019/homoode" target="_blank" rel="noopener">https://github.com/wadx2019/homoode</a><br><a href="https://github.com/SciML/DeepEquilibriumNetworks.jl" target="_blank" rel="noopener">https://github.com/SciML/DeepEquilibriumNetworks.jl</a> |
| Editable scale plan | `experiments/reproduction/configs/silva_homotopy_equilibrium.json` |
...
```text
dz/ds = T_theta(z,x) - z; T_theta(z_star,x)-z_star=0
```
...
```python
silva_homotopy_equilibrium(in_dim: 'int', state_dim: 'int', out_dim: 'int', *, transition: 'nn.Module | None' = None, readout: 'nn.Module | None' = None, steps: 'int' = 16, horizon: 'float' = 4.0, integrator: 'HomotopyIntegrator' = 'rk4', learnable_initial: 'bool' = True)
```
...
- Write and evaluate the family equation: `dz/ds = T_theta(z,x) - z; T_theta(z_star,x)-z_star=0`
