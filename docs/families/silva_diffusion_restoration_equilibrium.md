# `silva_diffusion_restoration_equilibrium` Reproduction Dossier

**joint fixed-point diffusion restoration.** This dossier connects the source mechanism to its SILVA
...
| Task contract | degraded image, observation mask, and initial noise -> solved reverse trajectory |
| Source relation | `paper-adaptation` |
| References | [[108]](../paper/references.md#ref-108){ .silva-cite } |
| Repositories | <a href="https://github.com/caojiezhang/DeqIR" target="_blank" rel="noopener">https://github.com/caojiezhang/DeqIR</a> |
| Editable scale plan | `experiments/reproduction/configs/silva_diffusion_restoration_equilibrium.json` |
...
```python
silva_diffusion_restoration_equilibrium(channels: 'int', timesteps: 'int', *, denoiser: 'nn.Module | None' = None, eta: 'float' = 0.15, config: 'SolverConfig | None' = None) -> 'None'
```
...
- Write and evaluate the family equation: `X_star=T_theta(X_star,y,mask,noise), X_star=(x_T_star,...,x_0_star)`
