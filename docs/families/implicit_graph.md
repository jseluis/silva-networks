# `implicit_graph` Reproduction Dossier

**well-posed implicit graph network.** This dossier connects the source mechanism to its SILVA
...
| Task contract | N,D features and adjacency/edge_index -> node/graph output |
| Source relation | `paper-adaptation` |
| References | [[36]](../paper/references.md#ref-36){ .silva-cite } |
| Repositories | <a href="https://github.com/SwiftieH/IGNN" target="_blank" rel="noopener">https://github.com/SwiftieH/IGNN</a> |
| Editable scale plan | `experiments/reproduction/configs/implicit_graph.json` |
...
```python
implicit_graph(in_dim: 'int', state_dim: 'int', out_dim: 'int', *, task: "Literal['node', 'graph']" = 'node', pooling: "Literal['mean', 'sum', 'max']" = 'mean', normalization: "Literal['symmetric', 'row', 'none']" = 'symmetric', activation: 'Callable[[Tensor], Tensor]' = <built-in method relu of type object>, input_projection: 'nn.Module | None' = None, state_projection: 'nn.Module | None' = None, transition_module: 'nn.Module | None' = None, readout: 'nn.Module | None' = None, config: 'SolverConfig | None' = None)
```
...
- Write and evaluate the family equation: `Z_star = phi(W Z_star A + B X)`
...
- citation, protein, chain, or graph-classification data
...
| --- | ---: |
| Initial loss | `0.318891` |
| Final loss | `0.0681874` |
| Fractional loss reduction | `0.786` |
| Residual or final increment norm | `6.26319e-05` |
| Iterations or tied increments | `20` |
| Parameter count | `51` |
| Final gradient norm | `0.597461` |
