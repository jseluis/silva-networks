# `sequence_deq` Reproduction Dossier

**relative-attention or trellis sequence equilibrium.** This dossier connects the source mechanism to its SILVA
...
| Task contract | token ids or B,L,D features -> sequence outputs |
| Source relation | `paper-adaptation` |
| References | [[4]](../paper/references.md#ref-4){ .silva-cite } |
| Repositories | <a href="https://github.com/locuslab/deq" target="_blank" rel="noopener">https://github.com/locuslab/deq</a> |
| Editable scale plan | `experiments/reproduction/configs/sequence_deq.json` |
...
```text
Z_star = T_theta(Z_star, embeddings, mask, memory)
```
...
- memory length
- adaptive vocabulary cutoffs

## Constructor and Shape Contract

```python
sequence_deq(dim: 'int', *, vocab_size: 'int | None' = None, input_dim: 'int | None' = None, output_dim: 'int | None' = None, mode: 'SequenceMode' = 'transformer', heads: 'int' = 8, inner_dim: 'int | None' = None, kernel_size: 'int' = 3, dropout: 'float' = 0.0, attention_dropout: 'float' = 0.0, local_window: 'int | None' = None, pre_norm: 'bool' = False, memory_length: 'int' = 0, tie_embeddings: 'bool | None' = None, adaptive_cutoffs: 'Sequence[int]' = (), adaptive_div_value: 'float' = 4.0, embedding_dim: 'int | None' = None, adaptive_input: 'bool | None' = None, tie_projections: 'bool' = True, transition_module: 'nn.Module | None' = None, embedding_module: 'nn.Module | None' = None, readout_module: 'nn.Module | None' = None, config: 'SolverConfig | None' = None)
```
...
- Write and evaluate the family equation: `Z_star = T_theta(Z_star, embeddings, mask, memory)`
...
- WikiText-103
- declared token or music sequence corpus
