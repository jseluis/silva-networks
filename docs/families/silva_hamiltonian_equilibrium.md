# `silva_hamiltonian_equilibrium` Reproduction Dossier

**self-consistent pairwise Hamiltonian equilibrium.** This dossier connects the source mechanism to its SILVA
...
| Task contract | B,N,F atom features and B,N,3 coordinates -> symmetric B,N,N Hamiltonian |
| Source relation | `paper-adaptation` |
| References | [[102]](../paper/references.md#ref-102){ .silva-cite } |
| Repositories | <a href="https://github.com/Zun-Wang/DEQHNet" target="_blank" rel="noopener">https://github.com/Zun-Wang/DEQHNet</a> |
| Editable scale plan | `experiments/reproduction/configs/silva_hamiltonian_equilibrium.json` |
...
```python
silva_hamiltonian_equilibrium(feature_dim: 'int', *, interaction: 'nn.Module | None' = None, contraction: 'float' = 0.4, config: 'SolverConfig | None' = None) -> 'None'
```
...
- Write and evaluate the family equation: `H_star=sym(Phi_theta(features, pairwise_distances)+gamma tanh(H_star))`
...
- MD17
- QH9
- molecular Hamiltonian prediction
