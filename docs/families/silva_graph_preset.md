# `silva_graph_preset` Reproduction Dossier

**configured graph reference architecture.** This dossier connects the source mechanism to its SILVA
...
| Task contract | node features and sparse edge_index -> node/graph output |
| Source relation | `silva-native` |
| References | [[1]](../paper/references.md#ref-1){ .silva-cite }, [[16]](../paper/references.md#ref-16){ .silva-cite }, [[17]](../paper/references.md#ref-17){ .silva-cite } |
...
| Editable scale plan | `experiments/reproduction/configs/silva_graph_preset.json` |
...
```python
silva_graph_preset(in_dim: 'int', hidden_dim: 'int | Sequence[int]', out_dim: 'int', *, task: 'TaskMode' = 'node', pooling: 'PoolingMode' = 'mean', attention_mode: 'AttentionMode' = 'simple', graph_mode: 'GraphMode' = 'GAT', num_heads: 'int' = 4, k_neighbors: 'int' = 16, local_depth: 'int' = 1, layer1_alpha: 'float' = 0.5, layer2_alpha: 'float' = 0.2, stack_alphas: 'Sequence[float] | None' = None, max_iter: 'int' = 15, solver: 'str' = 'picard', backward_mode: 'BackwardMode' = 'unrolled', backward_solver: 'BackwardSolverName' = 'gmres', backward_max_iter: 'int' = 50, backward_tol: 'float' = 1e-06, solver_configs: 'SolverConfig | Sequence[SolverConfig] | None' = None, head_hidden_dims: 'Sequence[int]' = (), dropout: 'float' = 0.0)
```
...
- Write and evaluate the family equation: `Z[l]_star = sigma(S[l](X[l]) + L_graph[l](Z[l]_star; E) + G[l](Z[l]_star; b))`
...
- citation networks
- molecular or graph property tasks
