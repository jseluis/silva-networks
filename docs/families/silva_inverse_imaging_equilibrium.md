# `silva_inverse_imaging_equilibrium` Reproduction Dossier

**known-operator inverse-imaging equilibrium.** This dossier connects the source mechanism to its SILVA
...
| Task contract | measurement y, forward A, adjoint A^T -> reconstructed image |
| Source relation | `paper-adaptation` |
| References | [[103]](../paper/references.md#ref-103){ .silva-cite } |
| Repositories | <a href="https://arxiv.org/abs/2102.07944" target="_blank" rel="noopener">https://arxiv.org/abs/2102.07944</a> |
| Editable scale plan | `experiments/reproduction/configs/silva_inverse_imaging_equilibrium.json` |
...
```python
silva_inverse_imaging_equilibrium(channels: 'int', *, forward_operator: 'Callable[[Tensor], Tensor] | nn.Module | None' = None, adjoint_operator: 'Callable[[Tensor], Tensor] | nn.Module | None' = None, prior: 'nn.Module | None' = None, step_size: 'float' = 0.5, config: 'SolverConfig | None' = None) -> 'None'
```
...
- Write and evaluate the family equation: `x_star=D_theta(x_star-eta A^T(A x_star-y))`
