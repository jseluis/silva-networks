...
**dynamic recurrent model with per-step algebraic equilibria.** This dossier connects the source mechanism to its SILVA
...
| References | [[109]](../paper/references.md#ref-109){ .silva-cite } |
| Repositories | <a href="https://arxiv.org/abs/2104.05942" target="_blank" rel="noopener">https://arxiv.org/abs/2104.05942</a> |
