# `silva_algorithmic_reasoner` Reproduction Dossier

**equilibrium graph processor for algorithmic reasoning.** This dossier connects the source mechanism to its SILVA
...
| Task contract | N,D node features plus edge_index -> solved node states and algorithm outputs |
| Source relation | `paper-adaptation` |
| References | [[101]](../paper/references.md#ref-101){ .silva-cite } |
| Repositories | <a href="https://github.com/HekpoMaH/DEAR" target="_blank" rel="noopener">https://github.com/HekpoMaH/DEAR</a><br><a href="https://github.com/google-deepmind/clrs" target="_blank" rel="noopener">https://github.com/google-deepmind/clrs</a> |
| Editable scale plan | `experiments/reproduction/configs/silva_algorithmic_reasoner.json` |
...
```python
silva_algorithmic_reasoner(input_dim: 'int', state_dim: 'int', output_dim: 'int', *, contraction: 'float' = 0.5, processor: 'nn.Module | None' = None, readout: 'nn.Module | None' = None, config: 'SolverConfig | None' = None) -> 'None'
```
...
- Write and evaluate the family equation: `h_v_star=tanh(E(x_v)+rho mean_(u,v) M_theta(h_u_star,h_v_star))`
